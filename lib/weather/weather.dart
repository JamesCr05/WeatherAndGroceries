                    ...
                    child: Column(
                      children: [
                        ...
                        TextButton(
                          ...
                          child: Text(
                            '${DateFormat('HH:mm').format(intervalTime)}  ${futureTemp1.round()} °C',
                            style: const TextStyle(
                              fontSize: 20,
                              color: Colors.white,
                            ),
                        ...
                        TextButton(
                          ...
                          child: Text(
                            '${DateFormat('HH:mm').format(intervalTime.add(const Duration(hours: 3)))}  ${futureTemp2.round()} °C',
                            style: const TextStyle(
                              fontSize: 20,
                              color: Colors.white,
                            ),
                        ...
                        TextButton(
                          ...
                          child: Text(
                            '${DateFormat('HH:mm').format(intervalTime.add(const Duration(hours: 6)))}  ${futureTemp3.round()} °C',
                            style: const TextStyle(
                              fontSize: 20,
                              color: Colors.white,
                            ),
